...
package org.onosproject.extend.gui;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.node.ArrayNode;
import com.fasterxml.jackson.databind.node.ObjectNode;
import com.google.common.collect.ImmutableList;
import org.onosproject.extend.gui.model.Bundle;
import org.onosproject.extend.gui.model.BundleDescriptor;
import org.onosproject.extend.gui.model.BundleFactory;
import org.onosproject.extend.gui.model.JsonFactory;
import org.onosproject.extend.gui.model.SubscriberUser;
import org.onosproject.extend.gui.model.UserFactory;
import org.onosproject.extend.gui.model.XosFunction;
import org.onosproject.extend.gui.model.XosFunctionDescriptor;
...
public class CordModelCache extends JsonFactory {
    ...
    public void setCurrentBundle(String bundleId) {
        ...
        for (SubscriberUser user: userMap.values()) {
            ...
            for (XosFunction f: currentBundle.functions()) {
                user.setMemento(f.descriptor(), f.createMemento());
                if (f.descriptor().equals(XosFunctionDescriptor.URL_FILTER)) {
    ...
    private void applyUrlFilterLevel(SubscriberUser user, String level) {
        XosFunction urlFilter = currentBundle.findFunction(XosFunctionDescriptor.URL_FILTER);
        if (urlFilter != null) {
